...
public final class AnimationConfig {
    public static final int SWAP_DURATION_MS = 200;
    ...
    public static final int BOARD_SHAKE_DURATION_MS = 200;
    public static final double CELL_SIZE_PX = 56.0;
    public static final double CELL_GAP_PX = 6.0;
    public static final double CELL_STEP_PX = CELL_SIZE_PX + CELL_GAP_PX;
